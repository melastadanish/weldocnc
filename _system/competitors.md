...
**URL:** xometry.com
**Model:** AI-powered marketplace connecting buyers to a network of vetted U.S. and international manufacturing partners. Not a single facility.

### Their Claims
| Claim | Their Number |
|---|---|
| Quoting | Instant via patented AI Quoting Engine® |
| Accuracy | Sub ±0.001″ (≈±0.025 mm) |
| Certifications | ISO 9001:2015, ISO 13485:2016, AS9100D, IATF 16949, ITAR, CMMC Level 2 |
| Services | CNC machining, 3D printing, sheet metal, injection molding, die casting |
| MOQ | None stated |

### Their Positioning
- "AI-Powered" and "Instant Quote" are the lead messages
- Targets startups through enterprises — breadth over depth
...
**URL:** hubs.com
**Model:** On-demand manufacturing platform; combines in-house Protolabs factories with a vetted global supplier network.

### Their Claims
| Claim | Their Number |
|---|---|
| Lead time | CNC/sheet metal from 5 business days; 3D printing from 1 day |
| Tolerances | CNC down to ±0.020 mm |
| Materials/finishes | 100+ combinations |
| Certifications | ISO 9001:2015, AS9100D |
| Customers | Intel, Audi, NASA, HP (named) |
| Global factories | Netherlands, Texas, UK, India, China |

### Their Positioning
- "World first" — in-house factories + global network combined
- Machine learning-based instant quoting with real-time pricing
...
**URL:** protolabs.com
**Model:** Technology-driven rapid manufacturing company with in-house automated factories. Primarily known for injection molding; CNC is a secondary service.

### Their Claims
| Claim | Their Number |
|---|---|
| Lead time | Parts in as fast as 1 day |
| CNC tolerances | Down to ±0.001″ (≈±0.025 mm) |
| CNC materials | 76 materials |
| Certifications | ISO 9001:2015, ISO 13485:2016, AS9100D, ITAR |
| Fortune 100 | Serves more than 90% of Fortune 100 companies (in target industries) |
| Additive experience | 25 years |

### Their Positioning
- "Manufacture Like a Pro™" tagline
- Single-source lifecycle partner: prototype → production
- AI/ML-powered DFM feedback before every order
...
|---|---|
| Experience | 15+ years |
| Parts manufactured | 100,000+ |
| Customers | 20,000+ across 120+ countries |
| On-time delivery | 98% |
| Certifications | ISO 9001:2015, ISO 13485, ISO 14001, IATF 16949 |
| Machines/centres | 700+ manufacturing centers |
| Services | CNC, injection molding, 3D printing, sheet metal, die casting, wire EDM, PCB |
| Clients (named) | Nikon, Toyota, Festo, Microsoft, Emerson |

### Their Positioning
- "Quality Parts Made Easier, Faster" tagline
- Positions as full product lifecycle partner (design → NPI → production → packaging)
- AI-driven platform with instant quoting, DFM analysis, production tracking
...
**URL:** fictiv.com
**Model:** Digital manufacturing platform; global network of vetted manufacturers in U.S., Mexico, India, China.

### Their Claims
| Claim | Their Number |
|---|---|
| Lead time | Parts as fast as 1 day |
| Parts manufactured | 35M+ |
| Companies served | 5,000+ |
| Fortune 500 usage | 61% |
| Material/process combinations | 4,100+ |
| Injection molding samples | 10 days |
| Certifications | ISO 9001:2015 |

### Their Positioning
- "Sourcing Simplified" — removes friction from the procurement process
- Positions against internal sourcing complexity, not vs. direct suppliers
- AI-powered DFM, Materials.AI (ChatGPT-powered), tariff management
- Named clients: Honeywell (aerospace), Nightside, Airvine Scientific
...
| **Stated tolerance** | ±0.005 mm | ±0.025 mm | ±0.020 mm | ±0.025 mm | Not stated | Not stated |
| **Certification** | ISO 9001:2015 | ISO 9001 + more | ISO 9001 + AS9100 | ISO 9001 + more | ISO 9001 + more | ISO 9001:2015 |
| **CMM report per order** | ✅ Yes | ❌ Not stated | ❌ Not stated | ❌ Not stated | ❌ Not stated | ❌ Not stated |
| **Location** | Dongguan, China | USA network | Global | USA + UK + more | Dongguan, China | USA + Global |
| **Quote speed** | 24 hours | Instant (AI) | Instant (ML) | Instant (AI) | Instant (AI) | Instant (AI) |
| **MOQ** | None | None | None | None | None | None |
...
- Do not fabricate customer counts or failure stories for competitors
- Only use the verified numbers in this file — re-verify before publishing if more than 3 months old
