...
- [x] 3. How It Works
- [x] 4. Why Choose Us
- [x] 5. Prototyping vs Production
- [x] 6. Industries Served
- [x] 7. Quality & Certifications
- [x] 8. Testimonials
- [x] 9. Blog / Resources
- [x] 10. FAQ
- [x] 11. Final CTA + Contact Form
...
**Design:** Horizontal timeline with dot connectors, light blue background section.

**Heading:** How It Works
**Subheading:** Upload a STEP file. Get a detailed quote in 24 hours. Receive inspected parts from 3 days.
...
## Section 5: Prototyping vs Production
**Design:** 2-column cards — left white card, right accent background card. Each: title + 3 points + CTA button. See [[reusablesections]] RS-05.
...
**Design:** Grid of cards — each card: industry photo (top), bold industry name, short description below. Clean white card, no overlay.
...
- **Defense** — Components manufactured to customer-supplied specifications and drawing revisions. Material certs, serialisation, and full inspection packages available. We work to your documentation requirements, not a generic standard.

---

## Section 7: Quality & Certifications
**Design:** Part A: 2-column (left: 4 points, right: ISO badge + CMM photo). Part B: 3-column quality process. See [[reusablesections]] RS-01.
...
**Part B — Quality Process (RS-01):**

| Step | Stage | Content |
|---|---|---|
| STEP 01 | Pre-Production | **Technical Assessment** — engineers review material grade, surface finish callout, critical features, and geometric tolerances against your drawing before programming begins. **Material Verification** — raw stock verified against material certificate including heat number, alloy grade, temper designation, and mechanical properties. |
| STEP 02 | In-Production | **In-Process Dimensional Checks** — part features measured at key machining stages, not only at the end. Fixturing and datum references verified before critical operations. **In-Process Quality Records** — ISO 9001:2015 compliant production traveller updated at each operation. Any deviation flagged and dispositioned before the job continues. |
| STEP 03 | Final-Production | **Full Dimensional Inspection Report** — all critical dimensions, thread gauging results, surface finish measurements, and visual inspection recorded against your drawing. Quantity verified. **Packaging** — parts individually wrapped in VCI film, EPE foam-padded, and shipped in reinforced carton or wooden case depending on part geometry and weight. |

---

## Section 8: Testimonials
**Design:** 3-card grid, 5-star rating, client name + job title, white cards on light grey background. See [[reusablesections]] RS-04.

**Heading:** What Our Clients Say
**Subheading:** Engineers and procurement managers across aerospace, medical, and industrial manufacturing.
...
## Section 9: Blog / Resources
**Design:** 3-card grid — category tag (top), blog title (bold), short description, "Read More →" link.

**Heading:** CNC Machining Resources
**Subheading:** Technical guides written by machinists and engineers — not marketing copy.

1. **What is CNC Machining? A Complete Beginner's Guide** | Knowledge Base — How CNC machining works — G-code, machine axes, cutting tools, work-holding, and when subtractive manufacturing beats every other process. → [[what-is-cnc-machining]]
2. **How to Design Parts for CNC Machining (DFM Guide)** | Knowledge Base — Wall thickness minimums, internal radii, hole depth-to-diameter ratios, and tolerance stack-up rules that reduce cost and prevent scrap. → [[design-for-manufacturability]]
3. **CNC Machining vs 3D Printing — Which Should You Choose?** | Knowledge Base — A process comparison based on material properties, tolerance capability, surface finish, lead time, and unit economics — not marketing claims. → [[cnc-vs-3d-printing]]

---

## Section 10: FAQ
**Design:** Accordion, white background, full width, first item open by default.

**Heading:** Frequently Asked Questions
**Subheading:** Straight answers on tolerances, lead times, materials, and how we work.

1. **What file formats do you accept?** — STEP is the preferred format for 3D parts. It retains full geometry, and GD&T data can be embedded via PMI — which genuinely speeds up quoting. We also accept IGES, DXF, DWG, and PDF. If you send a PDF drawing alongside a STEP file, the drawing is the authoritative tolerance source. When they contradict each other (it happens more than you'd think), we ask before we cut.
2. **What tolerances can you hold?** — Standard machining follows ISO 2768-m, which puts most dimensions at ±0.1mm. Tight tolerances down to ±0.005mm are achievable on features suited to that level of control — bore diameters, shaft fits, sealing faces. Part geometry, material, and tool access all affect what's actually practical. If a callout is pushing the boundary, we say so during DFM review rather than quoting it and hoping the machine cooperates.
3. **How fast can I get parts?** — Most orders ship in 3–5 business days. Complex 5-axis parts, hard alloys like titanium, or jobs requiring full first article inspection typically run 5–7 days. For urgent requirements, contact us directly — we schedule based on actual capacity, not a published list that may not reflect current loading.
...
**Design:** 2-column split — left: heading + bullets + CTA. Right: contact form. See [[reusablesections]] RS-03.
